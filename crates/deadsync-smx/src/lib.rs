...
/// shutdown. Worst-case work is 512 conversions for a two-slot setting change;
/// stable frames perform indexed byte loads only.
...
mod tests {
    use super::{
        PLATFORM_LIGHT_FRAME_BYTES, PLAYER_LIGHT_FRAME_BYTES, PLAYER_UNCONFIGURED_LIGHT,
        PLAYER1_LIGHT, PLAYER2_LIGHT, PadConfigData, PanelThresholds, SmxPadPreset,
        apply_brightness, brightness_factor, conflict_unresolved, indicator_color,
