...
const fn select_music_options(cfg: &Config) -> SelectMusicOptions {
    SelectMusicOptions {
        ...
        default_sort: cfg.select_music_default_sort,
        last_sort: cfg.select_music_last_sort,
        series_source: cfg.select_music_series_source,
        ...
        wheel_score_type: cfg.select_music_wheel_score_type,
        wheel_show_fails: cfg.select_music_wheel_show_fails,
        wheel_itl_points: cfg.select_music_wheel_itl_points,
