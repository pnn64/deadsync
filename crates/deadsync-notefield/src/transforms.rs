...
mod common_note_transform_tests {
    ...
    #[test]
    fn visibility_stealth_paths_match_reference_alpha_and_glow_behavior() {
        let cases = [
            NoteAlphaParams {
                hidden: 0.7,
                hidden_offset: 0.2,
    ...
    #[test]
    fn fade_blink_paths_match_reference_alpha_and_glow_behavior() {
        let cases = [
            NoteAlphaParams {
                hidden: 0.7,
                hidden_offset: 0.2,
    ...
    #[test]
    fn remaining_non_random_appearance_paths_match_reference_alpha_and_glow_behavior() {
        let cases = [
            NoteAlphaParams {
                hidden: 0.7,
                hidden_offset: 0.2,
            ...
            NoteAlphaParams {
                hidden: 0.7,
                hidden_offset: f32::INFINITY,
                sudden: 0.4,
                sudden_offset: f32::NEG_INFINITY,
                stealth: 0.15,
                blink: 0.1,
                ..NoteAlphaParams::default()
            },
    ...
    #[test]
    fn two_effect_boomerang_paths_match_per_note_reference_math() {
        let cases = [
            AccelYParams {
                boost: 0.35,
                boomerang: 0.3,
    ...
    #[test]
    fn two_effect_expand_paths_match_per_note_reference_math() {
        let cases = [
            AccelYParams {
                boost: 0.35,
                expand: 0.75,
...
pub mod transform_cache_bench_support {
    ...
    #[must_use]
    pub fn hidden_stealth_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_stealth_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn sudden_stealth_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn sudden_stealth_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn hidden_sudden_stealth_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_sudden_stealth_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn sudden_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn sudden_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn hidden_sudden_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_sudden_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_stealth_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_stealth_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn sudden_stealth_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn sudden_stealth_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                sudden: 0.4,
    ...
    #[must_use]
    pub fn hidden_sudden_stealth_blink_appearance_old(evaluations: usize) -> u64 {
        appearance_path_old(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn hidden_sudden_stealth_blink_appearance_new(evaluations: usize) -> u64 {
        appearance_path_new(
            evaluations,
            NoteAlphaParams {
                hidden: 0.7,
    ...
    #[must_use]
    pub fn boost_boomerang_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                boost: 0.35,
    ...
    #[must_use]
    pub fn boost_boomerang_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                boost: 0.35,
    ...
    #[must_use]
    pub fn brake_boomerang_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                brake: 0.2,
    ...
    #[must_use]
    pub fn brake_boomerang_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                brake: 0.2,
    ...
    #[must_use]
    pub fn wave_boomerang_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                wave: 0.4,
    ...
    #[must_use]
    pub fn wave_boomerang_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                wave: 0.4,
    ...
    #[must_use]
    pub fn boost_expand_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                boost: 0.35,
    ...
    #[must_use]
    pub fn boost_expand_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                boost: 0.35,
    ...
    #[must_use]
    pub fn brake_expand_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                brake: 0.2,
    ...
    #[must_use]
    pub fn brake_expand_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                brake: 0.2,
    ...
    #[must_use]
    pub fn boomerang_expand_old(evaluations: usize) -> u64 {
        accel_path_old(
            evaluations,
            AccelYParams {
                expand: 0.75,
    ...
    #[must_use]
    pub fn boomerang_expand_new(evaluations: usize) -> u64 {
        accel_path_new(
            evaluations,
            AccelYParams {
                expand: 0.75,
