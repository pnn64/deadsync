...
Use this through the default `derive` feature of `deadlib-bincode`; consumers
normally should not depend on this package directly. Source hashes and adaptation
notes are recorded in [`PROVENANCE.md`](PROVENANCE.md).
