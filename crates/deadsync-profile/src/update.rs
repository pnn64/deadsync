...
fn profile_ini_update(
    side: PlayerSide,
    update: impl FnOnce(&mut Profile) -> bool,
) -> ProfileUpdatePersistence {
...
pub fn update_last_played_for_side(
    ...
    if runtime_session_side_guest(side) {
        return ProfileUpdatePersistence::None;
    }
...
pub fn add_stage_calories_for_side(
    side: PlayerSide,
    calories_burned: f32,
) -> ProfileUpdatePersistence {
    if runtime_session_side_guest(side) {
...
pub fn update_player_initials_for_side(
    side: PlayerSide,
    initials: &str,
) -> ProfileUpdatePersistence {
    if runtime_session_side_guest(side) {
...
pub fn update_scroll_speed_for_side(
    side: PlayerSide,
...
pub fn update_background_filter_for_side(side: PlayerSide, value: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_background_filter_percent(value))
}

pub fn update_hold_judgment_graphic_for_side(
    side: PlayerSide,
    setting: HoldJudgmentGraphic,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_hold_judgment_graphic(setting))
}

pub fn update_held_miss_graphic_for_side(
    side: PlayerSide,
    setting: HeldMissGraphic,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_held_miss_graphic(setting))
}

pub fn update_judgment_graphic_for_side(
    side: PlayerSide,
    setting: JudgmentGraphic,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_judgment_graphic(setting))
}

pub fn update_combo_font_for_side(
    side: PlayerSide,
    setting: ComboFont,
) -> ProfileUpdatePersistence {
...
pub fn update_combo_colors_for_side(
    side: PlayerSide,
    setting: ComboColors,
) -> ProfileUpdatePersistence {
...
pub fn update_combo_mode_for_side(
    side: PlayerSide,
    setting: ComboMode,
) -> ProfileUpdatePersistence {
...
pub fn update_carry_combo_between_songs_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_current_combo_for_side(side: PlayerSide, combo: u32) -> ProfileUpdatePersistence {
    profile_stats_update(side, |profile| profile.set_current_combo(combo))
}

pub fn update_scroll_option_for_side(
    side: PlayerSide,
    setting: ScrollOption,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_scroll_option(setting))
}

pub fn update_turn_option_for_side(
    side: PlayerSide,
    setting: TurnOption,
) -> ProfileUpdatePersistence {
...
pub fn update_insert_mask_for_side(side: PlayerSide, mask: InsertMask) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_insert_mask(mask))
}

pub fn update_remove_mask_for_side(side: PlayerSide, mask: RemoveMask) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_remove_mask(mask))
}

pub fn update_holds_mask_for_side(side: PlayerSide, mask: HoldsMask) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_holds_mask(mask))
}

pub fn update_accel_effects_mask_for_side(
    side: PlayerSide,
...
pub fn update_visual_effects_mask_for_side(
    side: PlayerSide,
...
pub fn update_appearance_effects_mask_for_side(
    side: PlayerSide,
...
pub fn update_attack_mode_for_side(
    side: PlayerSide,
    setting: AttackMode,
) -> ProfileUpdatePersistence {
...
pub fn update_hide_light_type_for_side(
    side: PlayerSide,
    setting: HideLightType,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_hide_light_type(setting))
}

pub fn update_rescore_early_hits_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_timing_windows_for_side(
    side: PlayerSide,
    setting: TimingWindowsOption,
) -> ProfileUpdatePersistence {
...
pub fn update_column_flash_mask_for_side(
    side: PlayerSide,
...
pub fn update_column_flash_brightness_for_side(
    side: PlayerSide,
    setting: ColumnFlashBrightness,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_column_flash_brightness(setting))
}

pub fn update_column_flash_size_for_side(
    side: PlayerSide,
    setting: ColumnFlashSize,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_column_flash_size(setting))
}

pub fn update_transparent_density_graph_bg_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_smx_fsr_display_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_smx_pad_input_display_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_smx_bg_pack_for_side(side: PlayerSide, pack: &str) -> ProfileUpdatePersistence {
    let value = (!pack.is_empty()).then(|| pack.to_owned());
    profile_ini_update(side, |profile| profile.set_smx_bg_pack(value))
}

pub fn update_smx_judge_pack_for_side(side: PlayerSide, pack: &str) -> ProfileUpdatePersistence {
    let value = (!pack.is_empty()).then(|| pack.to_owned());
    profile_ini_update(side, |profile| profile.set_smx_judge_pack(value))
}

pub fn update_mini_indicator_for_side(
    side: PlayerSide,
    setting: MiniIndicator,
) -> ProfileUpdatePersistence {
...
pub fn update_mini_indicator_size_for_side(
    side: PlayerSide,
    setting: MiniIndicatorSize,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_mini_indicator_size(setting))
}

pub fn update_mini_indicator_color_for_side(
    side: PlayerSide,
    setting: MiniIndicatorColor,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_mini_indicator_color(setting))
}

pub fn update_mini_indicator_position_for_side(
    side: PlayerSide,
    setting: MiniIndicatorPosition,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_mini_indicator_position(setting))
}

pub fn update_noteskin_for_side(side: PlayerSide, setting: NoteSkin) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_noteskin(setting))
}

pub fn update_mine_noteskin_for_side(
    side: PlayerSide,
    setting: Option<NoteSkin>,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_mine_noteskin(setting))
}

pub fn update_receptor_noteskin_for_side(
    side: PlayerSide,
    setting: Option<NoteSkin>,
) -> ProfileUpdatePersistence {
...
pub fn update_tap_explosion_noteskin_for_side(
    side: PlayerSide,
    setting: Option<NoteSkin>,
) -> ProfileUpdatePersistence {
...
pub fn update_tap_explosion_mask_for_side(
    side: PlayerSide,
    setting: TapExplosionMask,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_tap_explosion_mask(setting))
}

pub fn update_notefield_offset_x_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_notefield_offset_y_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_judgment_offset_x_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_judgment_offset_y_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_combo_offset_x_for_side(side: PlayerSide, offset: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_combo_offset_x(offset))
}

pub fn update_combo_offset_y_for_side(side: PlayerSide, offset: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_combo_offset_y(offset))
}

pub fn update_error_bar_offset_x_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_error_bar_offset_y_for_side(
    side: PlayerSide,
    offset: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_mini_percent_for_side(side: PlayerSide, percent: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_mini_percent(percent))
}

pub fn update_spacing_percent_for_side(side: PlayerSide, percent: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_spacing_percent(percent))
}

pub fn update_perspective_for_side(
    side: PlayerSide,
...
pub fn update_no_cmod_alternative_for_side(
    side: PlayerSide,
    setting: NoCmodAlternative,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_no_cmod_alternative(setting))
}

pub fn update_visual_delay_ms_for_side(side: PlayerSide, ms: i32) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_visual_delay_ms(ms))
}

pub fn update_global_offset_shift_ms_for_side(
    side: PlayerSide,
    ms: i32,
) -> ProfileUpdatePersistence {
...
pub fn update_show_fa_plus_window_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_show_ex_score_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_show_ex_score(enabled))
}

pub fn update_show_hard_ex_score_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_show_fa_plus_pane_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_fa_plus_10ms_blue_window_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_track_early_judgments_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_scale_scatterplot_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_split_15_10ms_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_split_15_10ms(enabled))
}

pub fn update_custom_fantastic_window_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_custom_fantastic_window_ms_for_side(
    side: PlayerSide,
    ms: u8,
) -> ProfileUpdatePersistence {
...
pub fn update_pad_light_brightness_for_side(
    side: PlayerSide,
    value: i32,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_judgment_tilt_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_judgment_tilt(enabled))
}

pub fn update_column_cues_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_column_cues(enabled))
}

pub fn update_measure_cues_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_measure_cues(enabled))
}

pub fn update_crossover_cues_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_crossover_cues(enabled))
}

pub fn update_crossover_cue_brackets_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_crossover_cue_duration_ms_for_side(
    side: PlayerSide,
    ms: u16,
) -> ProfileUpdatePersistence {
...
pub fn update_crossover_cue_quantization_for_side(
    side: PlayerSide,
    quantization: u8,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_column_countdown_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_judgment_back_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_judgment_back(enabled))
}

pub fn update_error_ms_display_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_live_timing_stats_mask_for_side(
    side: PlayerSide,
    mask: LiveTimingStatsMask,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_live_timing_stats_mask(mask))
}

pub fn update_live_timing_stats_enabled_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_rainbow_max_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_rainbow_max(enabled))
}

pub fn update_responsive_colors_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_show_life_percent_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_tilt_multiplier_for_side(
    side: PlayerSide,
    multiplier: f32,
) -> ProfileUpdatePersistence {
...
pub fn update_tilt_thresholds_for_side(
    side: PlayerSide,
    min_ms: u32,
    max_ms: u32,
) -> ProfileUpdatePersistence {
...
pub fn update_error_bar_mask_for_side(
    side: PlayerSide,
    mask: ErrorBarMask,
) -> ProfileUpdatePersistence {
...
pub fn update_error_bar_trim_for_side(
    side: PlayerSide,
    setting: ErrorBarTrim,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_error_bar_trim(setting))
}

pub fn update_center_tick_for_side(side: PlayerSide, enabled: bool) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_center_tick(enabled))
}

pub fn update_text_error_bar_scalable_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_text_error_bar_threshold_ms_for_side(
    side: PlayerSide,
    ms: u32,
) -> ProfileUpdatePersistence {
...
pub fn update_average_error_bar_intensity_for_side(
    side: PlayerSide,
    intensity: f32,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_short_average_error_bar_enabled_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_average_error_bar_interval_ms_for_side(
    side: PlayerSide,
    ms: u32,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_long_error_bar_enabled_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_long_error_bar_intensity_for_side(
    side: PlayerSide,
    intensity: f32,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_long_error_bar_threshold_ms_for_side(
    side: PlayerSide,
    ms: u32,
) -> ProfileUpdatePersistence {
...
pub fn update_long_error_bar_min_samples_for_side(
    side: PlayerSide,
    n: u32,
) -> ProfileUpdatePersistence {
...
pub fn update_step_statistics_for_side(
    side: PlayerSide,
    mask: StepStatisticsMask,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_step_statistics(mask))
}

pub fn update_step_stats_extra_for_side(
    side: PlayerSide,
    setting: StepStatsExtra,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_step_stats_extra(setting))
}

pub fn update_display_scorebox_for_side(
    side: PlayerSide,
    enabled: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_lifemeter_type_for_side(
    side: PlayerSide,
    setting: LifeMeterType,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_lifemeter_type(setting))
}

pub fn update_error_bar_options_for_side(
    side: PlayerSide,
    up: bool,
    multi_tick: bool,
) -> ProfileUpdatePersistence {
...
pub fn update_measure_counter_for_side(
    side: PlayerSide,
    setting: MeasureCounter,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| profile.set_measure_counter(setting))
}

pub fn update_measure_counter_lookahead_for_side(
    side: PlayerSide,
    lookahead: u8,
) -> ProfileUpdatePersistence {
    profile_ini_update(side, |profile| {
...
pub fn update_measure_lines_for_side(
    side: PlayerSide,
    setting: MeasureLines,
) -> ProfileUpdatePersistence {
