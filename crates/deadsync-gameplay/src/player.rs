...
pub struct PlayerBufferCaps {
    pub combo_milestones: usize,
    pub life_history: usize,
    pub short_error_avg: usize,
    pub long_error_avg: usize,
}

impl PlayerBufferCaps {
...
impl Default for PlayerBufferCaps {
    fn default() -> Self {
        Self {
...
/// Maximum life-history points generated by a chart. The note term covers
/// mines and provisional early judgments, the row term covers finalized tap
/// judgments, and the hold/roll term covers tail judgments.
pub const fn life_history_capacity(
    note_count: usize,
    row_count: usize,
    ...
    note_count
        ...
        .saturating_add(hold_roll_count)
        .saturating_mul(2)
        .saturating_add(1)
}

/// Maximum error-bar samples generated by provisional note judgments and
/// finalized row judgments. Samples expire by time but never exceed this
/// whole-chart bound.
pub const fn error_avg_capacity(note_count: usize, row_count: usize) -> usize {
    note_count.saturating_add(row_count)
}

pub fn player_buffer_caps(
    note_count: usize,
    row_count: usize,
    hold_roll_count: usize,
    ...
    PlayerBufferCaps {
        ...
        short_error_avg: usize::from(average_visible && error_options.short_average_enabled)
            * error_capacity,
        long_error_avg: usize::from(average_visible && error_options.long_average_enabled)
            * error_capacity,
    }
}

pub fn init_player_runtime() -> PlayerRuntime {
    init_player_runtime_with_caps(PlayerBufferCaps::default())
}

pub fn init_player_runtime_with_caps(caps: PlayerBufferCaps) -> PlayerRuntime {
    PlayerRuntime {
        combo: 0,
        miss_combo: 0,
        ...
        combo_milestones: Vec::with_capacity(caps.combo_milestones),
        hands_achieved: 0,
        holds_held: 0,
        ...
        life_history: Vec::with_capacity(caps.life_history),
        ...
        error_bar_avg_samples: VecDeque::with_capacity(caps.short_error_avg),
        error_bar_long_avg_samples: VecDeque::with_capacity(caps.long_error_avg),
...
pub fn init_player_runtime_for_practice_with_caps(
...
pub fn init_player_runtime_for_song_with_caps(
    init_music_time: f32,
    in_course_stage: bool,
    course_carry: Option<CourseDisplayCarry>,
    carry_combo_between_songs: bool,
...
pub fn reset_player_runtime_for_practice(
    ...
    let mut error_bar_long_avg_samples = std::mem::take(&mut player.error_bar_long_avg_samples);
    combo_milestones.clear();
    life_history.clear();
    error_bar_avg_samples.clear();
    error_bar_long_avg_samples.clear();

    let mut reset = init_player_runtime_with_caps(PlayerBufferCaps::EMPTY);
    reset.combo_milestones = combo_milestones;
    reset.life_history = life_history;
    reset.error_bar_avg_samples = error_bar_avg_samples;
    reset.error_bar_long_avg_samples = error_bar_long_avg_samples;
    reset
        .life_history
        .push((judge_start_music_time, reset.life));
    *player = reset;
}
