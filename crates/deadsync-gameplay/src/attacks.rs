...
pub struct SongLuaRuntimeVisuals<OverlayActor, CapturedActor, StateDelta> {
    ...
    pub player_judgment_events: [Vec<SongLuaOverlayMessageRuntime>; MAX_PLAYERS],
    pub player_combo_events: [Vec<SongLuaOverlayMessageRuntime>; MAX_PLAYERS],
    pub song_foreground: CapturedActor,
    pub song_foreground_events: Vec<SongLuaOverlayMessageRuntime>,
...
pub const fn build_song_lua_runtime_visuals<OverlayActor, CapturedActor, StateDelta>(
    ...
    player_judgment_events: [Vec<SongLuaOverlayMessageRuntime>; MAX_PLAYERS],
    player_combo_events: [Vec<SongLuaOverlayMessageRuntime>; MAX_PLAYERS],
