...
@group(1) @binding(1) var u_y: texture_2d<f32>;
@group(1) @binding(2) var u_u: texture_2d<f32>;
@group(1) @binding(3) var u_v: texture_2d<f32>;
struct YuvConversion {
    levels: vec4<f32>,
    coeffs: vec4<f32>,
};
@group(1) @binding(4) var<uniform> u_conversion: YuvConversion;
