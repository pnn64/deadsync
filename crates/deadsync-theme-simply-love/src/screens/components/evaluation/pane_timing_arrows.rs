...
const LEFT_FOOT_RGBA: [f32; 4] = deadlib_present::color::rgba_hex("#FF3030");
const RIGHT_FOOT_RGBA: [f32; 4] = deadlib_present::color::rgba_hex("#3070FF");
const LABEL_RGBA: [f32; 4] = deadlib_present::color::rgba_hex("#A0A0A0");
const VALUE_RGBA: [f32; 4] = deadlib_present::color::rgba_hex("#FFFFFF");
