...
// when other HUD values change. At most ten such actors can coexist (two mini
// indicators, two offsets, and six timing pairs); four transient buffers per
// actor cover fill/stroke plus their shadow copies.
