...
pub struct State {
    ...
    pub(super) judgment_palette_presentation: RefCell<Option<JudgmentPalettePresentation>>,
...
pub fn init(view: OptionsInitView) -> State {
    ...
    let mut state = State {
        ...
        judgment_palette_presentation: RefCell::new(None),
        judgment_palettes,
    ...
    set_choice_by_id(
        ...
        MACHINE_OPTIONS_ROWS,
        SubRowId::EasterEggs,
        usize::from(cfg.machine_easter_eggs),
    );
    set_choice_by_id(
        &mut state.sub[SubmenuKind::Machine].choice_indices,
        MACHINE_OPTIONS_ROWS,
