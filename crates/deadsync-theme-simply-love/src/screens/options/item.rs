...
pub const ITEMS: &[Item] = &[
    ...
    Item {
        ...
        help: &[
            ...
            HelpEntry::Bullet(lookup_key("OptionsMachine", "EasterEggs")),
    ...
    Item {
        ...
        help: &[
            ...
            HelpEntry::Bullet(lookup_key("OptionsSelectMusic", "HideInactiveSeries")),
            HelpEntry::Bullet(lookup_key("OptionsSelectMusic", "DefaultSort")),
            HelpEntry::Bullet(lookup_key("OptionsSelectMusic", "SeriesSource")),
