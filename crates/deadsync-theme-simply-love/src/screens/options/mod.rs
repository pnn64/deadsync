...
use crate::config::{
    ...
    null_or_die_kernel_type_choice_index,
    ...
    srpg_shop_folder_choice_index, srpg_variant_choice_index, srpg_variant_from_choice,
    sync_graph_mode_choice_index, version_overlay_side_choice_index,
