...
pub use position::{
    ...
    bump_music_map_generation, clear_music_stream_clock_seed, fallback_music_position,
    fallback_stream_position_frames, load_callback_clock_snapshot_now, mark_music_track_started,
    music_clock_seed_enabled, music_gain_snap_generation, music_map_generation,
    music_nanos_from_seconds, music_target_gain, music_total_frames, music_track_active,
    music_track_active_relaxed, music_track_has_started, music_track_start_frame,
    next_music_track_id, normalized_music_rate, note_timing_diag_callback_gap,
    publish_callback_window_end, publish_callback_window_start_nanos,
    reset_music_stream_clock_state, reset_music_target_gain, seed_music_stream_clock,
...
pub use telemetry::{
    ...
    record_stutter_diag_event, report_audio_render_callback,
    stutter_diag_callback_gap_threshold_ns, stutter_diag_trigger_seq,
};
