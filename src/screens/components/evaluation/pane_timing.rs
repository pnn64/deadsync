...
pub fn build_timing_pane(
    ...
    children.push(act!(text: font(current_theme_font_key_for_text(FontRole::Header, "Early")): settext("Early"):
        align(0.0, 0.0): xy(10.0, early_late_y):
        zoom(0.3):
    ));
    children.push(act!(text: font(current_theme_font_key_for_text(FontRole::Header, "Late")): settext("Late"):
