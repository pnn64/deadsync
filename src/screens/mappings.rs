...
pub fn get_actors(
    ...
    ui_actors.push(act!(text:
        ...
        diffuse(1.0, 1.0, 1.0, 1.0):
        font(current_theme_font_key(FontRole::Header)): settext("Player 1"):
        horizalign(center)
    ));
    ui_actors.push(act!(text:
        align(0.5, 0.5):
        ...
        zoom(header_main_zoom):
        diffuse(1.0, 1.0, 1.0, 1.0):
        font(current_theme_font_key(FontRole::Header)): settext("Player 2"):
        horizalign(center)
    ));
    ...
    ui_actors.push(act!(text:
        ...
        font(current_theme_font_key(FontRole::Header)): settext("Primary"):
        horizalign(center)
    ));
    ui_actors.push(act!(text:
        align(0.5, 0.5):
        ...
        zoom(header_zoom):
        diffuse(header_dec[0], header_dec[1], header_dec[2], header_dec[3]):
        font(current_theme_font_key(FontRole::Header)): settext("Secondary"):
        horizalign(center)
    ));
    ui_actors.push(act!(text:
        align(0.5, 0.5):
        ...
        zoom(header_zoom):
        diffuse(header_dec[0], header_dec[1], header_dec[2], header_dec[3]):
        font(current_theme_font_key(FontRole::Header)): settext("Default"):
        horizalign(center)
    ));
