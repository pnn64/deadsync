...
pub fn get_actors(state: &State, asset_manager: &AssetManager) -> Vec<Actor> {
    ...
    if state.current_pane == OptionsPane::Main {
        for player_idx in active_player_indices(active) {
            ...
            actors.push(act!(text: font(current_theme_font_key(FontRole::Header)): settext(speed_text):
            ...
            if scaled_scroll != main_scroll {
                ...
                actors.push(act!(text: font(current_theme_font_key(FontRole::Header)): settext(scaled_text):
