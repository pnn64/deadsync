...
use deadsync_profile::{
    ActiveProfile, AttackMode, BackgroundFilter, DEFAULT_BIRTH_YEAR, DEFAULT_WEIGHT_POUNDS,
    DataVisualizations, ErrorBarTrim, GameplayHudPlayerSnapshot, GameplayHudSnapshot,
    HideLightType, LifeMeterType, LocalProfileSummary, MeasureCounter, MeasureLines,
    MiniIndicatorSize, PLAYER_INITIALS_MAX_LEN, PLAYER_SLOTS, Perspective, PlayMode, PlayStyle,
    PlayerSide, ScatterplotMaxWindow, TimingTickMode, TimingWindowsOption,
};
pub use update::*;
...
mod tests {
    use super::{
        ...
        AVERAGE_ERROR_BAR_INTERVAL_MS_MIN, AVERAGE_ERROR_BAR_INTERVAL_MS_STEP, DEFAULT_BIRTH_YEAR,
        DEFAULT_WEIGHT_POUNDS, LONG_ERROR_BAR_INTENSITY_DEFAULT, LONG_ERROR_BAR_INTENSITY_MAX,
        ...
        Profile, TapExplosionMask, TimingWindowsOption, clamp_average_error_bar_intensity,
        clamp_average_error_bar_interval_ms, clamp_long_error_bar_intensity, initials_from_name,
