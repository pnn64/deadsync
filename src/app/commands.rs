...
use deadsync_shell::{
    BannerSlot, Command, DeferredCommandResourceContext, DeferredCommandRootEffect,
    apply_deferred_command_process_plan, deferred_command_apply_plan, execute_command_resources,
...
impl App {
    ...
    fn deferred_command_context(&self) -> DeferredCommandResourceContext {
        DeferredCommandResourceContext {
            ...
            show_video_backgrounds: crate::config::get().show_video_backgrounds,
    ...
    fn apply_deferred_effect(
        &mut self,
        effect: deadsync_shell::DeferredCommandEffect,
