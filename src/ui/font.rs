...
const MAP_KOREAN_JAMO: &[u32] = &[
    0x1100, 0x1110, 0x1120, 0x1130, 0x1140, 0x1150, 0x1160, 0x1170, 0x1180, 0x1190, 0x11a0, 0x11b0,
    0x11c0, 0x11d0, 0x11e0, 0x11f0, 0x1101, 0x1111, 0x1121, 0x1131, 0x1141, 0x1151, 0x1161, 0x1171,
    0x1181, 0x1191, 0x11a1, 0x11b1, 0x11c1, 0x11d1, 0x11e1, 0x11f1, 0x1102, 0x1112, 0x1122, 0x1132,
    0x1142, 0x1152, 0x1162, 0x1172, 0x1182, 0x1192, 0x11a2, 0x11b2, 0x11c2, 0x11d2, 0x11e2, 0x11f2,
    0x1103, 0x1113, 0x1123, 0x1133, 0x1143, 0x1153, 0x1163, 0x1173, 0x1183, 0x1193, 0x11a3, 0x11b3,
    0x11c3, 0x11d3, 0x11e3, 0x11f3, 0x1104, 0x1114, 0x1124, 0x1134, 0x1144, 0x1154, 0x1164, 0x1174,
    0x1184, 0x1194, 0x11a4, 0x11b4, 0x11c4, 0x11d4, 0x11e4, 0x11f4, 0x1105, 0x1115, 0x1125, 0x1135,
    0x1145, 0x1155, 0x1165, 0x1175, 0x1185, 0x1195, 0x11a5, 0x11b5, 0x11c5, 0x11d5, 0x11e5, 0x11f5,
    0x1106, 0x1116, 0x1126, 0x1136, 0x1146, 0x1156, 0x1166, 0x1176, 0x1186, 0x1196, 0x11a6, 0x11b6,
    0x11c6, 0x11d6, 0x11e6, 0x11f6, 0x1107, 0x1117, 0x1127, 0x1137, 0x1147, 0x1157, 0x1167, 0x1177,
    0x1187, 0x1197, 0x11a7, 0x11b7, 0x11c7, 0x11d7, 0x11e7, 0x11f7, 0x1108, 0x1118, 0x1128, 0x1138,
    0x1148, 0x1158, 0x1168, 0x1178, 0x1188, 0x1198, 0x11a8, 0x11b8, 0x11c8, 0x11d8, 0x11e8, 0x11f8,
    0x1109, 0x1119, 0x1129, 0x1139, 0x1149, 0x1159, 0x1169, 0x1179, 0x1189, 0x1199, 0x11a9, 0x11b9,
    0x11c9, 0x11d9, 0x11e9, 0x11f9, 0x110a, 0x111a, 0x112a, 0x113a, 0x114a, 0x115a, 0x116a, 0x117a,
    0x118a, 0x119a, 0x11aa, 0x11ba, 0x11ca, 0x11da, 0x11ea, 0x11fa, 0x110b, 0x111b, 0x112b, 0x113b,
    0x114b, 0x115b, 0x116b, 0x117b, 0x118b, 0x119b, 0x11ab, 0x11bb, 0x11cb, 0x11db, 0x11eb, 0x11fb,
    0x110c, 0x111c, 0x112c, 0x113c, 0x114c, 0x115c, 0x116c, 0x117c, 0x118c, 0x119c, 0x11ac, 0x11bc,
    0x11cc, 0x11dc, 0x11ec, 0x11fc, 0x110d, 0x111d, 0x112d, 0x113d, 0x114d, 0x115d, 0x116d, 0x117d,
    0x118d, 0x119d, 0x11ad, 0x11bd, 0x11cd, 0x11dd, 0x11ed, 0x11fd, 0x110e, 0x111e, 0x112e, 0x113e,
    0x114e, 0x115e, 0x116e, 0x117e, 0x118e, 0x119e, 0x11ae, 0x11be, 0x11ce, 0x11de, 0x11ee, 0x11fe,
    0x110f, 0x111f, 0x112f, 0x113f, 0x114f, 0x115f, 0x116f, 0x117f, 0x118f, 0x119f, 0x11af, 0x11bf,
    0x11cf, 0x11df, 0x11ef, 0x11ff,
];

const MAP_NUMBERS: &[u32] = &[
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x0025, 0x002E,
    0x0020, 0x003A, 0x0078,
];
...
fn apply_charmap_range(
    ...
    if map_offset >= len {
        warn!("range map offset {map_offset} exceeds charmap length {len}; skipping.");
        return;
    }
    ...
    if remaining > 0 {
        warn!("range map overflow (offset={map_offset}, count={requested}, len={len})");
    }
}
