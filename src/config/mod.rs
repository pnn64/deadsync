...
pub use deadsync_config::options::{
    ...
    clamped_max_fps, default_fail_type_choice_index, default_fail_type_from_choice,
    ...
    language_choice_index, language_flag_from_choice, log_level_choice_index,
    log_level_from_choice, machine_bar_color_choice_index, machine_bar_color_from_choice,
